...
import 'package:plegado_de_boletos/models/demo_data.dart';
...
class FlightSummary extends StatelessWidget {
    ...
    return isLight
        ...
        : BoxDecoration(
            ...
            image: DecorationImage(
                image: AssetImage('images/bg_blue.png', package: MyApp.pkg),
                fit: BoxFit.cover),
          );
  }
  ...
  Widget _buildTicketDuration() {
    ...
    final planeImage = Image.asset('images/airplane_$routeType.png',
        height: 20, fit: BoxFit.contain, package: MyApp.pkg);
    return Container(
      child: Column(
            ...
            child: Stack(
              ...
              children: <Widget>[
                Image.asset('images/planeroute_$routeType.png',
                    fit: BoxFit.cover, package: MyApp.pkg),
                isLight
                    ? planeImage
